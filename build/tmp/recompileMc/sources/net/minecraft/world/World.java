...
public abstract class World implements IBlockAccess, net.minecraftforge.common.capabilities.ICapabilityProvider
{
    ...
    public void updateEntities()
    {
        ...
        if (!this.tileEntitiesToBeRemoved.isEmpty())
        {
            ...
            // forge: faster "contains" makes this removal much more efficient (MC-117075)
            java.util.Set<TileEntity> remove = java.util.Collections.newSetFromMap(new java.util.IdentityHashMap<TileEntity, Boolean>());
