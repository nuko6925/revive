        ...
        else
        {
            ...
            for (int i : packetIn.getPassengerIds())
            {
                ...
                else
                {
                    ...
                    {
                        this.gameController.ingameGUI.setOverlayMessage(I18n.format("mount.onboard", new Object[] {this.gameController.gameSettings.keyBindSneak.getDisplayName()}), false);
                    }
                }
            }
        }
